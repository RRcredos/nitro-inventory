...
NITRO_INVENTORY_KNOWLEDGE_BASE_REMOTE_BRANCH="${NITRO_INVENTORY_KNOWLEDGE_BASE_REMOTE_BRANCH:-${KNOWLEDGE_BASE_REMOTE_BRANCH:-${MEMORY_BANK_REMOTE_BRANCH:-main}}}"
...
Environment overrides (KNOWLEDGE_BASE_* and MEMORY_BANK_* accepted as legacy aliases):
  ...
  NITRO_INVENTORY_KNOWLEDGE_BASE_REMOTE_BRANCH Default: main
EOF
}
